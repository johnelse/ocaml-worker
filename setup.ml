...
(* OASIS_START *)
(* DO NOT EDIT (digest: ca3941d275977c72ef8c8109be92da9c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("cmdliner", None)];
                   ...
                   {
                      lib_modules = ["Worker_io"; "Worker"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "worker";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Worker_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "worker";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "unix";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "worker"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\239\244\141\025.\147\179\167Y\207\133/\214\237R ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
